...
function ShapeLandingBackground({ className }: { className?: string }) {
  return (
    <div className={cn("absolute inset-0 overflow-hidden pointer-events-none", className)}>
      ...
      <ElegantShape
        ...
        className="right-[-8%] md:right-[-2%] top-[66%] md:top-[72%]"
      />
      <ElegantShape
        delay={0.35}
        width={280}
        ...
        className="left-[2%] md:left-[8%] bottom-[4%] md:bottom-[10%]"
      />
      <ElegantShape
        delay={0.58}
        width={210}
        ...
        className="right-[10%] md:right-[16%] top-[8%] md:top-[13%]"
      />
      <ElegantShape
        delay={0.68}
        width={160}
        ...
        className="left-[18%] md:left-[24%] top-[4%] md:top-[9%]"
      />
    </div>
  );
}
